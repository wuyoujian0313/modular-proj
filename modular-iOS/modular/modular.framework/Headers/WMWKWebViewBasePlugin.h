...
@interface WMWKWebViewBasePlugin : NSObject
@property(nonatomic,weak) WMBaseVC                  * _Nullable vc;
...
// 删除数据
- (void)JN_RemoveValueWithKey:(NSString*_Nonnull)key;
...
- (void)JN_AESEncrypt:(NSString *_Nonnull)content;
